...
public class StudentHomeFragment extends Fragment {
    ...
    MaterialButton newRequest, approveRequest, allRequest;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newRequest = view.findViewById(R.id.newPassRequestBtn);
        approveRequest = view.findViewById(R.id.passRequestsApproveBtn);

        newRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(),StudentNewPassActivity.class));
        ...
        approveRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(),StudentApprovedRequestActivity.class));
            }
        });
